...
export default function App() {
  ...
  const fileCount = myFiles.length;
      ...
      <div className="App">
        ...
        <div style={styles.container}>
          <div style={{ padding: 10, paddingBottom: 0 }}>
            ...
            <p style={{ fontWeight: "bold" }}>Total Files: {fileCount}</p> {/* Display the file count */}
          </div>
            ...
            <button style={styles.controlButton}
              onClick={() => {
                if (selectedFile) {
                  // Filter out the selected file from the list
          ...
          <div style={styles.fileContainer}>
            <div style={{ width: "100%", padding: 10 }}>
              {myFiles.map((file) => {
                if (file.path.slice(0, filePath.length) === filePath && file.name.toLowerCase().includes(searchInput.toLowerCase())) {
                  return (
